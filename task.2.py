...
class Road:
    def __init__(self, length, width):
        ...
        self._weight = self._length*self._width*(float(input('Input weight of asphalt per sq/m: ')))*(float(input('Input thickness of asphalt: ')))
        print(f'Weight is :{int(self._weight/1000)}T')
